...
/// Integration test: start an `HttpServer` on an ephemeral port, query `/readyz`,
/// then signal shutdown and verify the server stops accepting connections.
#[tokio::test]
async fn http_server_readyz_integration() {
