...
"""
NATS Logs Viewer
Streams logs from the NATS container in real-time
"""
...
CONTAINER_NAME = "robotorq-network-nats-1"

def main():
    parser = argparse.ArgumentParser(description="Stream NATS container logs")
    parser.add_argument(
        "--tail",
        type=int,
        default=50,
