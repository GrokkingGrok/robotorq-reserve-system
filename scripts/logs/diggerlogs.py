...
"""
Digger Logs Viewer
Streams logs from the Digger container in real-time
"""
...
CONTAINER_NAME = "robotorq-network-digger-1"

def main():
    parser = argparse.ArgumentParser(description="Stream Digger container logs")
    parser.add_argument(
        "--tail",
        type=int,
        default=50,
