#!/usr/bin/env python3
"""
DistoDam Logs Viewer
Streams logs from the DistoDam container in real-time
"""
...
CONTAINER_NAME = "robotorq-network-distodam-1"

def main():
    parser = argparse.ArgumentParser(description="Stream DistoDam container logs")
    parser.add_argument(
        "--tail",
        type=int,
        default=50,
